        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
            ...
            <div class="relative flex flex-col items-stretch bg-white rounded-lg shadow h-96 md:h-128 lg:h-160">
                ...
                <div class="absolute inset-x-0 bottom-0 z-20 p-4">
                    ...
                    <div class="mt-6 flex justify-center">
                        <a href="{{ route('admin.learning-panel.blog-post.index') }}" class="inline-block bg-white text-gray-700 px-4 py-2 rounded-md hover:bg-sky-100 transition-colors duration-300">Learn More</a>
                    </div>
                </div>
            </div>
            <!-- Home Page Card -->
            <div class="relative flex flex-col items-stretch bg-white rounded-lg shadow h-96 md:h-128 lg:h-160">
                ...
                <div class="absolute inset-x-0 bottom-0 z-20 p-4">
                    ...
                    <div class="mt-6 flex justify-center">
                        <a href="{{ route('admin.learning-panel.home-page.index') }}" class="inline-block bg-white text-gray-700 px-4 py-2 rounded-md hover:bg-sky-100 transition-colors duration-300">Learn More</a>
                    </div>
                </div>
            </div>
            <!-- About Page Card -->
            <div class="relative flex flex-col items-stretch bg-white rounded-lg shadow h-96 md:h-128 lg:h-160">
                ...
                <div class="absolute inset-x-0 bottom-0 z-20 p-4">
                    ...
                    <div class="mt-6 flex justify-center">
                        <a href="{{ route('admin.learning-panel.about-page.index') }}" class="inline-block bg-white text-gray-700 px-4 py-2 rounded-md hover:bg-sky-100 transition-colors duration-300">Learn More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex flex-col items-stretch bg-white rounded-lg shadow h-96 md:h-128 lg:h-160">
                ...
                <div class="absolute inset-x-0 bottom-0 z-20 p-4">
                    ...
                    <div class="mt-6 flex justify-center">
                        <a href="{{ route('admin.learning-panel.contact.index') }}" class="inline-block bg-white text-gray-700 px-4 py-2 rounded-md hover:bg-sky-100 transition-colors duration-300">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
