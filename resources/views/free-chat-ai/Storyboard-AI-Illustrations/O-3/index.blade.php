    ...
    <div id="tm-wrap">
        <div class="tm-main-content">
            <div class="container tm-site-header-container">
                <div>
                      <iframe src="https://www.yeschat.ai/i/gpts-2OToJOWbtp-Storyboard-Artist" width="800" height="500" style="max-width: 100%;"></iframe>
                </div>
                ...
                <section style="margin: 3rem;">
                    <section class="flex-container">
                        <div class="flex-item">
                            ...
                            <button onclick="if (!window.open('{{ url('free-chat-ai/PDF-Research-Assistant/O-3') }}', '_blank').opener) return false;">Create Now!</button>
                        </div>
                        <div class="flex-item">
                            <p style="height: 60px;">Research GPT</p>
                            <button onclick="if (!window.open('{{ url('free-chat-ai/Research-GPT/O-3') }}', '_blank').opener) return false;">Create Now!</button>
                        </div>
                        <div class="flex-item">
                            <p style="height: 60px;">Storyboard AI Illustrations</p>
                            <button onclick="if (!window.open('{{ url('free-chat-ai/Storyboard-AI-Illustrations/O-3') }}', '_blank').opener) return false;">Create Now!</button>
                        </div>
                        <div class="flex-item">
                            <p style="height: 60px;">Python Assistant</p>
                            <button onclick="if (!window.open('{{ url('free-chat-ai/Python-Assistant/O-3') }}', '_blank').opener) return false;">Create Now!</button>
                        </div>
                    </section>
                </section>                 
            </div>
